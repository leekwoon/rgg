...
from rgg.rgg import RGGPipeline, pipeline_kwargs
...
np.savez_compressed(
    os.path.join(log_dir, f'{args.spec}_s{SEED}_n{args.num_episodes}_np{args.num_plan}_sc{args.scale}.npz'),
    paths=paths,
    score_mean=mean,
    score_err=err
)
