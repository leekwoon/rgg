...
from rgg.pipeline_diffuser import (
    DiffuserEditPipeline, # maze2d case
    pipeline_kwargs
)
...
def parse_args():
    ...
    parser.add_argument('--env_name', type=str, default='maze2d-large-v1', 
        help='')
    parser.add_argument('--data_path', type=str, default='./logs/data/maze2d-large-v1-H384-T256/500000_finish.npz', help='',
    )
    ...
    parser.add_argument('--num_plan', type=int, default=10, 
...
def main(args):
    ...
    edit_pipeline = DiffuserEditPipeline.from_pretrained(
        args.diffusers_repo,
    ...
    while cur_idx < n:
        ...
        conditions = {
            ...
            plan_hor - 1: trajectories[:, -1, action_dim:],
        }
