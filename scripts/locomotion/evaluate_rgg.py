...
from rgg.rgg import ValueRGGPipeline, pipeline_kwargs
...
np.savez_compressed(
    os.path.join(log_dir, f'{args.spec}_s{SEED}_n{args.num_episodes}_np{args.num_plan}_sc{args.scale}_b{args.beta}.npz'),
    paths=paths,
    score_mean=mean,
    score_err=err
)
